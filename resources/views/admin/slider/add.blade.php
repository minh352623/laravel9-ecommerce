...
<form action="" method="POST" enctype="multipart/form-data" >
    <div class="row">
        ...
        <div class="col-12"> <div class="mb-4">
            ...
            <input value="{{old('image_path')}}" name="image_path"   type="file" class="form-control-file @error('image_path') is-invalid @enderror">
            @error('image_path')
                <span class="text-danger mt-2">{{$message}}</span>
            @enderror
        </div></div>
        ...
        <div class="col-12"><div class="mb-4">
            ...
            <textarea name="description" rows="3"  type="text" class="form-control my-editor @error('description') is-invalid @enderror">{{old('description')}}</textarea>
            @error('description')
                <span class="text-danger mt-2">{{$message}}</span>
            @enderror
        </div></div>
