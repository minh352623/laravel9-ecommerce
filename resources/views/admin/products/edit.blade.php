    ...
    <div class="row">
        <div class="col-6">
            <div class="mb-4">
                ...
                <input value="{{old('name') ?? $product->name}} " name="name" type="text" class="form-control" placeholder="Tên sản phẩm...">
                @error('name')
        ...
        <div class="col-6"> <div class="mb-4">
            ...
            <input value="{{old('price')  ?? $product->price}}" name="price" type="text" class="form-control" placeholder="Giá sản phẩm...">
            @error('price')
                <span class="text-danger mt-2">{{$message}}</span>
            @enderror
        </div></div>
        <div class="col-6"> <div class="mb-4">
            ...
            <input value="{{old('feature_image_path')}}" name="feature_image_path"  type="file" class="form-control-file">
            @error('feature_image_path')
                <span class="text-danger mt-2">{{$message}}</span>
            @enderror
            
            <div class="imgae mt-2" style="height:150px;width:200px"><img src="{{$product->feature_image_path}}" alt=""></div>
        </div></div>
        <div class="col-6">   <div class="mb-4">
            <label for="">Ảnh chi tiết</label>
            <input value="{{old('image_path')}}" multiple name="image_path[]"  type="file" class="form-control-file">
            @error('image_path')
                <span class="text-danger mt-2">{{$message}}</span>
            @enderror
            <div class="row">
        ...
        <div class="col-6"> <div class="mb-4">
            ...
            <select class="form-control selected2_init" name=category_id>
        ...
        <div class="col-12"><div class="mb-4">
            ...
            <textarea name="content" rows="3"  type="text" class="form-control my-editor">{{old('content') ?? $product->content}}</textarea>
            @error('content')
                <span class="text-danger mt-2">{{$message}}</span>
            @enderror
        </div></div>
